...
int howManyBits(int x) {
  ...
  int shift1 = !(!(operations >> 1)) << 0;
  operations = shift16 + shift8 + shift4 + shift2 + shift1 + 2;
  return negOps | (operations & oppSign);
}
//float
/* 
